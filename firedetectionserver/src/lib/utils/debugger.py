...
class Debugger(object):
  def __init__(self, ipynb=False, theme='black', 
               num_classes=-1, dataset=None, down_ratio=4, class_names = None):
    self.ipynb = ipynb
    if not self.ipynb:
    ...
    elif num_classes == 94 or dataset == 'objdet':
  ...
  def add_rect(self, rect1, rect2, c =  (0,0,255), conf=1, img_id='default'): 
...
custom_class_name = ['giraffe', 'bed', 'person', 'chair', 'hair', 'scissors', 'fire', 'auto', 'car', 'bus', 'bird', 'baseball bat', 'baseball glove', 'dog', 'umbrella', 'helmet', 'cap', 'bicycle', 'license plate', 'tv', 'laptop', 'mouse', 'keyboard', 'apple', 'cell phone', 'book', 'vest', 'motorbike', 'sports ball', 'tennis racket', 'bottle', 'sink', 'bowl', 'pizza', 'zebra', 'airplane', 'cat', 'toilet', 'frisbee', 'truck', 'remote', 'clock', 'bald', 'cup', 'fork', 'knife', 'dining table', 'cow', 'train', 'boat', 'donut', 'wine glass', 'fire hydrant', 'surfboard', 'skis', 'vase', 'tie', 'couch', 'potted plant', 'banana', 'refrigerator', 'handbag', 'snowboard', 'bench', 'backpack', 'horse', 'suitcase', 'microwave', 'stop sign', 'parking meter', 'cake', 'toothbrush', 'broccoli', 'bear', 'traffic light', 'diningtable', 'spoon', 'motorcycle', 'oven', 'kite', 'carrot', 'skateboard', 'hot dog', 'sheep', 'elephant', 'orange', 'sandwich', 'teddy bear', 'hair drier', 'toaster', 'sofa', 'pottedplant', 'tvmonitor', 'aeroplane']
